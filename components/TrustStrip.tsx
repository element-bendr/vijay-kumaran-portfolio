...
const TRUST = [
  { name: "Sterling Synergies", role: "Industrial supplies", quote: "Rebuilt our online presence. Clean, fast, handles enquiries.", slug: "sterling", alt: "Sterling Synergies industrial supplies client website" },
  { name: "Sopranos Inc.", role: "Construction", quote: "Professional site that actually brings in leads.", slug: "sopranos", alt: "Sopranos Inc. construction client website" },
  { name: "GreenShoot", role: "Environmental service", quote: "No maintenance headaches. It just runs.", slug: "greenshoot", alt: "GreenShoot environmental service client website" },
];
      ...
      <div className="mx-auto max-w-7xl px-6 py-10 sm:px-10 lg:px-16">
        ...
        >
          {TRUST.map((t) => (
            ...
            >
              <img src={`/projects/${t.slug}.avif`} alt={t.alt} className="mb-4 w-full border border-dark-line" />
