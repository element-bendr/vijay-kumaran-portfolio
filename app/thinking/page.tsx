...
export default function ThinkingPage() {
  return <PageShell>
    <section className="bg-dark text-light"><div className="mx-auto max-w-7xl px-6 py-14 sm:px-10 lg:px-16 lg:py-16"><SectionLabel>Thinking</SectionLabel><h1 className="display mt-6 max-w-4xl text-[clamp(2.95rem,5.7vw,5.75rem)] leading-[.92]">Notes on building<br /><span className="text-cyan">systems that run.</span></h1><p className="mt-7 max-w-2xl text-lg leading-relaxed text-muted-dark">Field notes from the work — what generalizes, what breaks, and what holds up.</p></div></section>
