...
export const metadata: Metadata = createMetadata({
  path: "/services",
  title: "AI Systems, Automation & Web Engineering Services",
  description: "Governed AI systems, internal automation, production web platforms, and evidence-led systems audits.",
});

export default function ServicesPage() {
  return <PageShell>
    <section className="bg-dark text-light"><div className="mx-auto max-w-7xl px-6 py-14 sm:px-10 lg:px-16 lg:py-16"><SectionLabel>Services</SectionLabel><MaskedHeadline className="display mt-6 max-w-5xl text-[clamp(3.1rem,6vw,6rem)] leading-[.92]"><MaskedLine>Build the system.</MaskedLine><MaskedLine><span className="text-cyan">Prove it works.</span></MaskedLine></MaskedHeadline><p className="mt-7 max-w-2xl text-lg leading-relaxed text-muted-dark">AI systems, internal automation, and production web platforms designed with explicit controls, evidence, failure handling, and maintainable delivery.</p></div></section>
