...
export const projectKnowledgeRefresh: ProjectKnowledgeRecord[] = [
  ...
  },
  {
    ...
    sources: [{ label: "PCAS case study", path: "app/work/pcas/page.tsx" }],
  },
  {
    id: "newsharness",
    project: "newsharness",
  ...
  },
  {
    ...
    sources: [{ label: "Memory OS Autonomy case study", path: "app/work/memory-os-autonomy/page.tsx" }],
  },
  {
    id: "little-agent",
    ...
    sources: [{ label: "little-agent case study", path: "app/work/little-agent/page.tsx" }],
  },
  {
    id: "palimpsest",
    project: "Palimpsest",
    ...
    sources: [{ label: "Palimpsest case study", path: "app/work/palimpsest/page.tsx" }],
  },
  {
